...
export class BudgetComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.userInitial = this.userName
      ...
      : this.userEmail.charAt(0).toUpperCase() || 'U';
  ...
  onSubmit(): void {
    ...
    this.http
      .post(`${environment.apiBaseUrl}/users/add-simple-budget`, {
  ...
  private loadBudgets(): void {
    ...
    this.http
      .get(
        `${environment.apiBaseUrl}/users/simple-budget-list?userEmail=${encodeURIComponent(
          this.userEmail
        )}`
      )
      .subscribe({
  ...
  deleteBudget(budgetId: string) {
    ...
    this.http
      .delete(
        `${environment.apiBaseUrl}/users/delete-budget/${budgetId}?userEmail=${encodeURIComponent(
          this.userEmail
        )}`
      )
      .subscribe({
